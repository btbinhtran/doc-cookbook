...
function parseArgs(args) {
  var options = require('commander')
    ...
    .option('-m, --modules <modules>', 'Comma seperated list of tower module names to generate main docs')
    ...
    if (typeof options.modules !== 'undefined')
      options.modules = options.modules.replace(' ','').split(',');
...
exports.create = function(recipe, args, fn){
  ...
  var towerModules = options.modules || ['adapter', 'cookbook', 'expression', 'route', 'type', 'cli', 'directive', 'query', 'template', 'validator', 'content', 'element', 'resource', 'text'];
