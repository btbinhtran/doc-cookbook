...
exports.create = function(recipe, args, fn){
  ...
  var towerModules = ["guides","template","directive","show-directive","expression","element","validate-directive","render","attr-directive","directives","markdown-directive","text-directive","element-directive","content-directive","event-directive","style-directive","component-cookbook","cli","list-directive","ec2-adapter","mongodb-cookbook","neo4j-cookbook","ec2-cookbook","ssh-cookbook","workstation-cookbook","stream","cookbook","recipe","server-router","validator","type","topology","todomvc","text","strcase","server","run-loop","route","resource","query","program","param","operator","mongodb-adapter","memory-adapter","load","keyboard-directive","fs","emitter","content","console","collection","client-router","attr","adapter","uuid","style-guide","relation","proxy","asset","s3-cookbook","input-directive","accessor","filter","rest-adapter","cassandra-cookbook","app-cookbook","node-cookbook","server-template","reload","client-session","client-socket","server-socket","bundler","builder","orientdb-cookbook","redis-cookbook","facebook-adapter","couchdb-adapter","mysql-adapter","postgres-adapter"];
